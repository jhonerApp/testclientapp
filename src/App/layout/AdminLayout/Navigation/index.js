...
import * as actionTypes from './../../../../store/Action/Menu/actions';
    ...
    render() {
        ...
        let navContent = (
            <div className="navbar-wrapper">
                <NavLogo collapseMenu={this.props.collapseMenu}  onToggleNavigation={this.props.onToggleNavigation} />
...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.page.preLayout,
        collapseMenu: state.page.collapseMenu,
        layoutType: state.page.layoutType,
        navBackColor: state.page.navBackColor,
        navBackImage: state.page.navBackImage,
        navIconColor: state.page.navIconColor,
        navBrandColor: state.page.navBrandColor,
        layout6Background: state.page.layout6Background,
        layout6BackSize: state.page.layout6BackSize,
        rtlLayout: state.page.rtlLayout,
        navFixedLayout: state.page.navFixedLayout,
        boxLayout: state.page.boxLayout,
        navDropdownIcon: state.page.navDropdownIcon,
        navListIcon: state.page.navListIcon,
        navActiveListColor: state.page.navActiveListColor,
        navListTitleColor: state.page.navListTitleColor,
        navListTitleHide: state.page.navListTitleHide
    }
};
