...
import DEMO from "../../../../store/Constant/Menu/constant";
                ...
                <header className={headerClass.join(' ')}>
                    <div className="m-header">
                        ...
                        <a href={DEMO.BLANK_LINK} className="b-brand">
                            ...
                            <span className="b-title">CLIENT INFORMATION</span>
                        </a>
                    </div>
...
const mapStateToProps = state => {
    return {
        ...
        headerBackColor: state.page.headerBackColor,
        headerFixedLayout: state.page.headerFixedLayout,
